<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <title>تعديل روابط السوشال ميديا</title>
        <meta charset="utf-8">
					    ...
					    <div class="row">
						   ...
						   <input type="hidden"  name="id" value=" {{ $social->id }} ">
							  ...
							  <a href="#" class="fa fa-twitter" ></a>
								...
								<input type="text" class="form-control" name="twetter" value="{{ $social->twetter }} ">
							  </div>
                              <pre>                      </pre>
							  <div class="mb-3">
...
<pre>                         </pre>
			  <div class="col-12">
			  	<div class="d-grid" style="height: 10%;">
                	<button type="submit" class="btn btn-primary" ><h3> تعديل  الرابط </h3> </button>
				</div>
			</div>
		</form>
	</div>
...
<div class="container my-5">
                    <footer >
                        ...
                        <div>
                            ...
                            <a href="{{$social->twetter}}" class="fa fa-twitter" ></a>
                            <a href="{{$social->whatsapp}}" class="fa fa-whatsapp"></a>
                            <a href="{{$social->youtube}}" class="fa fa-youtube"></a>
