                    ...
                    <nav class="navbar navbar-expand-md navbar-light" style="background-color:white">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="/newproduct"><i class="fas fa-feather-alt me-2"></i></i> إضافة منتجات</a></li>
                                <li class="nav-item"> <a class="nav-link" href="/addnewabout"><i class="fas fa-feather-alt me-2"></i></i>إضافة من نحن</a></li>
                                <li class="nav-item"> <a class="nav-link" href="/slider"><i class='fas fa-phone me-2'></i> عارض الصور </a></li>
                                <li class="nav-item"> <a class="nav-link" href="/social"><i class='fas fa-phone me-2'></i>  سوشال ميديا </a></li>
					...
					<div class="panel panel-default">
						<form method="post" action="{{ url('newproduct/store') }}"  enctype="multipart/form-data">
							...
							<div class="page-content">
												...
												<div class="col-lg-4">
													<div class="border border-3 p-4 rounded">
														...
														<div class="mb-3">
															...
															<input name="image" type="file" accept=".xlsx,.xls,image/*,.doc,audio/*,.docx,video/*,.ppt,.pptx,.txt,.pdf" multiple required> 
														</div>
													</div>
												</div>
												<div class="col-lg-8">
								...
								<!--================================================French=======================================================-->
									<div class ="fr" id="French" align ="left" dir='ltr'>
										<div class="card" style="background-repeat: no-repeat;background-position: center;background-color: #F1F9F9;">
											<div class="card-body p-4">
												<div class="form-body mt-4">
													<h5 class="card-title">Ajouter le produit en français</h5>
													<hr/>
													<div class="row">
														<div class="border border-3 p-4 rounded">
															<div class="row g-3">
																<div class="col-md-12">
																	...
																	<input type="text" class="form-control" name="product_name_fr" placeholder="Entrez le nom du produit" required>
																</div>
																<div class="col-md-12">
																	<div class="col-md-12">
																		<label for="inputProductDescription" class="form-label"><b>La description</b></label>
																		<textarea class="form-control" name="productdescription_fr" rows="3" placeholder="Entrez la description du produit" required></textarea>
																	</div>
																</div>
															</div> 
														</div>
								...
								<!--================================================Arabic=======================================================-->
									<div class ="ar" id="arabic" align ="right" dir='rtl'>
										<div class="card" style="background-repeat: no-repeat;background-position: center;background-color: #F1F9F9;">
											<div class="card-body p-4">
												<div class="form-body mt-4">
													<h5 class="card-title">اضف المنتج باللغة العربية</h5>
													<hr/>
													<div class="row">
														<div class="border border-3 p-4 rounded">
															<div class="row g-3">
																<div class="col-md-12">
																	...
																	<input type="text" class="form-control" name="product_name_ar" placeholder="ادخل اسم المنتج" required>
																</div>
																<div class="col-md-12">
																	<div class="col-md-12">
																		<label for="inputProductDescription" class="form-label"><b>مواصفات المنتج</b></label>
																		<textarea class="form-control" name="productdescription_ar" rows="3" placeholder="ادخل مواصفات المنتج" required></textarea>
																	</div>
																</div>
															</div> 
														</div>
														...
														<div class="border border-3 p-4 rounded">
															<div class="row g-3">
																<div class="col-md-12">
																	...
																	<input type="text" class="form-control" name="product_name_du" placeholder="ادخل اسم المنتج" required>
																</div>
																<div class="col-md-12">
																	<div class="col-md-12">
																		<label for="inputProductDescription" class="form-label"><b>Beschrijving </b></label>
																		<textarea class="form-control" name="productdescription_du" rows="3" placeholder="ادخل مواصفات المنتج" required></textarea>
																	</div>
																</div>
															</div> 
														</div>
														...
														<div class="border border-3 p-4 rounded">
															<div class="row g-3">
																<div class="col-md-12">
																	...
																	<input type="text" class="form-control" name="product_name_gr" placeholder="ادخل اسم المنتج" required>
																</div>
																<div class="col-md-12">
																	<div class="col-md-12">
																		<label for="inputProductDescription" class="form-label"><b> Beschreibung</b></label>
																		<textarea class="form-control" name="productdescription_gr" rows="3" placeholder="ادخل مواصفات المنتج" required></textarea>
																	</div>
																</div>
															</div> 
														</div>
		...
		<div class="container my-5">
                    <footer >
						...
						@foreach( $social as $row )
                            ...
                            <a href="{{$row->twetter}}" class="fa fa-twitter" ></a>
                            <a href="{{$row->whatsapp}}" class="fa fa-whatsapp"></a>
                            <a href="{{$row->youtube}}" class="fa fa-youtube"></a>
